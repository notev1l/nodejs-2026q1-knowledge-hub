...
export class CategoryController {
  ...
  @ApiOkResponse({ description: 'Array of category records', type: [CategoryResponse] })
  getCategories() {
  ...
  @ApiNotFoundResponse({ description: 'Category not found' })
  updateCategory(@Param('id', new ParseUUIDPipe()) id: string, @Body() dto: CreateCategoryRequest) {
